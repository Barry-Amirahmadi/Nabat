...
export function Button({
  ...
  const classes = cn("btn", variant === "primary" ? "btn--primary" : "btn--ghost", className);
  ...
  if (href) {
    /* onClick is applied here as well as on the <button> below. It was
       declared and silently dropped for links in the template this engine
       came from, which is how the mobile menu's own CTA navigated without
       ever running the onClose it was given. */
    return (
